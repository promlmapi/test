...
class ExportDateFilterButton extends React.Component {
    ...
    exportFile({ fileType }) {
        ...
        if (typeof advance_export_option !== 'undefined' && !isEmpty(advance_export_option)) {
            URI = this.props.apiUrl + '?file_type=' + fileType + '&filter='+ filterDateString + '&advanced_option='+advance_export_option;
        }else if (typeof impersonated_user_option !== 'undefined' && !isEmpty(impersonated_user_option)) {
            URI = this.props.apiUrl + impersonated_user_option +'&file_type=' + fileType + '&filter='+ filterDateString;

        } else {
            URI = this.props.apiUrl + '?file_type=' + fileType + '&filter='+ filterDateString;
        }
...
export default translate()(ExportDateFilterButton);