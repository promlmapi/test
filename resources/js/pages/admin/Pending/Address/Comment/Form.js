...
import { dataGetSalesStatusList } from '../../../../../custom/Libraries/Data';
...
class CommentSectionForm extends React.Component {
    ...
    render() {
        ...
        const { error, handleSubmit, submitting, pristine, salesStatusDetail, basicSalesManagers } = this.props;
        //Get sales status list
        let salesStatusList = dataGetSalesStatusList(BasicField.salesStatus.lang.defaultOption, salesStatusDetail);
        ...
        return(
            <Form onSubmit={handleSubmit } noValidate>
                ...
                <Field
                    ...
                    name={ BasicField.salesStatus.name }
                    label={ BasicField.salesStatus.lang.title }
                    options={salesStatusList}
                    placeholder={ BasicField.salesStatus.lang.defaultOption }
                    required
                />
