    ...
    render() {
        ...
        return(
            <Form onSubmit={handleSubmit } noValidate>
                ...
                {i18n.t('nav.header.links.uploaddocument.title')}
                </Header>
                <Message
                    size='tiny'
                    icon='info'
                    header={i18n.t('nav.header.links.uploaddocumentlimit.title')}
                    content={i18n.t('nav.header.links.uploaddocumentmsg.title')}
                />
